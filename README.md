...
- Phase 016-027: TUI replay fixtures, app smoke unknown resolution, xterm/vttest compatibility expansion, representative app certification tracking, secondary device attributes, function/modified key encoding, application keypad mode, OSC 52 clipboard write, legacy/modifier-aware mouse encoding, selection drag autoscroll, and OSC title updates are implemented.
