...
- Phase 016-094: TUI replay fixtures, app smoke unknown resolution, xterm/vttest compatibility expansion, representative app certification tracking, secondary device attributes, function/modified key encoding, exhaustive modifier key tests, application keypad mode, OSC 52 clipboard write/query policy, legacy/modifier-aware mouse encoding, mode-gated SGR mouse runtime evidence, selection drag autoscroll, OSC title updates, vttest menu replay/app runtime evidence, htop runtime redraw/quit/F10/F1 help evidence, fzf interactive redraw/preview/selection/multi-select/shell Ctrl-T/Alt-C/Ctrl-R evidence, less direct quit evidence, git pager quit/page navigation/search/horizontal scroll/mark evidence, vim edit/write/quit evidence, tmux attached session, split-pane, and nested vim evidence, Tab/Esc input fixes, absolute scrollback selection, app command smoke automation, app target command smokes, representative CLI version app smokes, DEC Special Graphics G0-G3 locking/single/right-side shift charset support, British/Dutch/French-Canadian/German/Finnish/French/Greek/Hebrew/Italian/DEC Supplemental Graphics/DEC Technical/DEC Cyrillic/DEC Greek Supplemental/DEC Hebrew Supplemental/DEC Turkish Supplemental/ISO Greek Supplemental/ISO Hebrew Supplemental/ISO Latin-Cyrillic Supplemental/ISO Latin-1 Supplemental/ISO Latin-2 Supplemental/JIS-Katakana/JIS-Roman/Norwegian-Danish/Portuguese/Russian/SCS/Spanish/Swedish/Swiss/Turkish charset support, and `codex` CLI version smoke fallback are implemented.
