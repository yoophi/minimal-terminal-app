...
- Phase 016-030: TUI replay fixtures, app smoke unknown resolution, xterm/vttest compatibility expansion, representative app certification tracking, secondary device attributes, function/modified key encoding, application keypad mode, OSC 52 clipboard write, legacy/modifier-aware mouse encoding, selection drag autoscroll, OSC title updates, vttest menu replay evidence, Tab/Esc input fixes, and absolute scrollback selection are implemented.
