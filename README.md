...
- Phase 016-161: TUI replay fixtures, app smoke unknown resolution, xterm/vttest compatibility expansion, representative app certification tracking, secondary device attributes, function/modified key encoding, exhaustive modifier key tests, native modified function/navigation key runtime evidence, native Up/F5 modifier matrix runtime evidence, native Shift/Control/Option/Shift+Option/Shift+Control/Control+Option/Shift+Control+Option F1-F12 function key runtime evidence, native Control+Option, Shift+Control, Shift+Option, Shift+Control+Option, Shift, Control, and Option non-word navigation family runtime evidence, application keypad/autowrap mode, OSC 52 clipboard write/query policy, legacy/modifier-aware mouse encoding, combined/mode-gated SGR mouse runtime evidence, native synthetic NSEvent mouse evidence, native AppKit window resize evidence, selection drag autoscroll, OSC title updates, vttest version/menu replay/app runtime/cursor movement/screen features/character sets/double-sized/DSR/primary DA/secondary DA evidence, htop runtime layout/AppKit cell width rendering/cell-clipped AppKit rendering/styled cell background rendering/background color erase/autowrap/VT index scroll/combined mouse mode/quit/F10/mouse F2 Setup/F1 help/F5 tree/F2 setup/setup save/setup Tree view toggle/elevated layout marker evidence, fzf interactive redraw/preview/preloaded preview query/selection/multi-select/shell Ctrl-T/Alt-C/Ctrl-R evidence and preview/Ctrl-T/Alt-C smoke timing stabilization, less direct quit/search/follow and mouse wheel evidence with follow timing stabilization, git pager quit/page navigation/search/horizontal scroll/mark evidence with repository-path-stable app smokes, vim edit/write/quit/mouse left press/window split key chord/resize redraw evidence, tmux attached session, split-pane, pane resize, copy mode, mouse wheel direction stabilization, nested vim, split-pane nested vim resize evidence with repository-path-stable helper script execution, and app target smoke wait budget stabilization, shell `$HOME` startup and shell exit notice app smokes, claude/codex version and help output evidence, Tab/Esc input fixes, absolute scrollback selection, app command smoke automation, app target command smokes, representative CLI version app smokes, 8-bit C1 CSI introducer evidence, 8-bit C1 SS2/SS3 single shift support, 8-bit C1 OSC/ST support, DEC Supplemental UPSS alias support, DEC Special Graphics G0-G3 locking/single/right-side shift charset support, British/Dutch/French-Canadian/German/Finnish/French/Greek/Hebrew/Italian/DEC Supplemental Graphics/DEC Technical/DEC Cyrillic/DEC Greek Supplemental/DEC Hebrew Supplemental/DEC Turkish Supplemental/ISO Greek Supplemental/ISO Hebrew Supplemental/ISO Latin-Cyrillic Supplemental/ISO Latin-5 Supplemental/ISO Latin-1 Supplemental/ISO Latin-2 Supplemental/JIS-Katakana/JIS-Roman/Norwegian-Danish/Portuguese/Russian/SCS/Spanish/Swedish/Swiss/Turkish charset support, and `codex` CLI version smoke fallback are implemented.
