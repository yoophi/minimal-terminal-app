...
- Phase 016-044: TUI replay fixtures, app smoke unknown resolution, xterm/vttest compatibility expansion, representative app certification tracking, secondary device attributes, function/modified key encoding, exhaustive modifier key tests, application keypad mode, OSC 52 clipboard write/query policy, legacy/modifier-aware mouse encoding, selection drag autoscroll, OSC title updates, vttest menu replay/app runtime evidence, htop runtime redraw/quit/F10 evidence, fzf interactive redraw/selection evidence, git pager quit/page navigation evidence, Tab/Esc input fixes, absolute scrollback selection, app command smoke automation, app target command smokes, representative CLI version app smokes, and DEC Special Graphics charset support are implemented.
