...
- code-level로 검증된 modifier key variants 중 Control+F5, Shift+Option+Up, Control+Option+Right 외 나머지 조합을 앱별 runtime smoke로 검증한다.
