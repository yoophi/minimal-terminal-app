...
- application keypad mode와 numeric keypad encoding을 확장한다.
...
Phase 021에서 F1-F12, Shift/Option/Control modifier가 붙은 navigation/function key의 xterm-style encoding을 추가했다. 기존 Option 단독 word navigation은 shell 편집 UX를 위해 유지한다. application keypad와 모든 modifier variant의 runtime app smoke는 full xterm gap으로 남긴다.
