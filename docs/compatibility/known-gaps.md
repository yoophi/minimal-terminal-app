...
- code-level로 검증된 modifier key variants 중 Up/F5 key 전체 modifier matrix와 Control+Option/Shift+Control/Shift+Option/Shift+Control+Option/Shift/Control navigation family 및 Option non-word navigation family 외 나머지 navigation/function 조합을 앱별 runtime smoke로 검증한다.
