...
| Character set designation | `ESC ( 0`, `ESC ( B`, `ESC ) 0`, `ESC ) B`, `ESC * 0`, `ESC * B`, `ESC + 0`, `ESC + B`, `SO`, `SI`, `ESC n`, `ESC o`, `ESC N`, `ESC O`, unsupported G-set designations | partially supported | `parser::tests::parses_ascii_charset_designation`, `parser::tests::maps_dec_special_graphics_charset`, `parser::tests::maps_g1_dec_special_graphics_with_locking_shift`, `parser::tests::maps_g2_and_g3_dec_special_graphics_with_locking_shift`, `parser::tests::maps_g2_and_g3_dec_special_graphics_with_single_shift`, `state::tests::renders_dec_special_graphics_line_drawing`, `state::tests::renders_g1_dec_special_graphics_with_locking_shift`, `state::tests::renders_g2_and_g3_dec_special_graphics_with_locking_shift`, `state::tests::renders_g2_and_g3_dec_special_graphics_with_single_shift`, `tests/compatibility.rs::dec_special_graphics_have_core_evidence`, `docs/compatibility/known-gaps.md` | G0-G3 DEC Special Graphics line drawing은 Unicode box drawing 문자로 매핑한다. G2/G3 single shift도 지원한다. right-side G-set locking shift, 기타 charset은 범위 밖이다. |
