...
| Character set designation | `ESC ( 0`, `ESC ( B`, unsupported G-set designations | partially supported | `parser::tests::parses_ascii_charset_designation`, `parser::tests::maps_dec_special_graphics_charset`, `state::tests::renders_dec_special_graphics_line_drawing`, `tests/compatibility.rs::dec_special_graphics_have_core_evidence`, `docs/compatibility/known-gaps.md` | G0 DEC Special Graphics line drawing은 Unicode box drawing 문자로 매핑한다. G1/G2/G3 locking shift와 기타 charset은 범위 밖이다. |
