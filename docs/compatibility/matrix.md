...
| `vttest` | partially supported | Phase 018 environment check: `/opt/homebrew/bin/vttest`, `vttest -V` -> `VT100 test program, version 2.7 (20251205)`, `tests/tui_replay.rs::vttest_menu_replay_renders_menu_and_queues_da_response`, `docs/compatibility/known-gaps.md` | 설치/version smoke와 시작 메뉴 replay fixture는 확인했다. interactive menu runtime result는 known gap으로 남긴다. |
