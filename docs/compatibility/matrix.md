...
| `codex-cli` | partially supported | Phase 019 environment check: `codex-cli 0.139.0`, `docs/compatibility/known-gaps.md` | 이전 version smoke evidence는 있으나 현재 PATH에서는 `codex-cli`를 찾지 못해 app-internal version smoke는 skip된다. interactive prompt workflow는 수동 smoke로 남긴다. |
