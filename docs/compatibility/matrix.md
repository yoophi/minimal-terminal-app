...
| Character set designation | `ESC ( 0`, `ESC ( B`, `ESC ) 0`, `ESC ) B`, `SO`, `SI`, unsupported G-set designations | partially supported | `parser::tests::parses_ascii_charset_designation`, `parser::tests::maps_dec_special_graphics_charset`, `parser::tests::maps_g1_dec_special_graphics_with_locking_shift`, `state::tests::renders_dec_special_graphics_line_drawing`, `state::tests::renders_g1_dec_special_graphics_with_locking_shift`, `tests/compatibility.rs::dec_special_graphics_have_core_evidence`, `docs/compatibility/known-gaps.md` | G0/G1 DEC Special Graphics line drawing은 Unicode box drawing 문자로 매핑한다. G2/G3 locking shift, single shift, 기타 charset은 범위 밖이다. |
