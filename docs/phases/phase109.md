...
- pane에 120줄 output을 만들고 smoke hook의 `wheel-down-20` mouse reports를 보낸다.
- snapshot에서 history scroll marker `tmux-mouse-scroll-marker`를 확인한다.
...
- app snapshot에 `tmux-mouse-scroll-marker` marker가 남는다.
