...
mod tests {
    ...
    fn native_key_smoke_event_maps_known_cases() {
        ...
        assert_eq!(
            super::native_key_smoke_event("shift-f12"),
            Some((NSEventModifierFlags::Shift, 111))
        );
        assert_eq!(
            super::native_key_smoke_event("control-f12"),
            Some((NSEventModifierFlags::Control, 111))
        );
        assert_eq!(
            super::native_key_smoke_event("option-f12"),
            Some((NSEventModifierFlags::Option, 111))
        );
        assert_eq!(
            super::native_key_smoke_event("shift-option-f12"),
            Some((
        ...
        assert_eq!(
            super::native_key_smoke_event("control-option-f12"),
            Some((
        ...
        assert_eq!(
            super::native_key_smoke_event("shift-control-option-f12"),
            Some((
                NSEventModifierFlags::Shift
                    | NSEventModifierFlags::Control
                    | NSEventModifierFlags::Option,
        ...
        assert_eq!(
            super::native_key_smoke_event("shift-option-page-down"),
            Some((
                NSEventModifierFlags::Shift | NSEventModifierFlags::Option,
                121
            ))
        ...
        assert_eq!(
            super::native_key_smoke_event("shift-control-option-page-down"),
            Some((
                NSEventModifierFlags::Shift
                    | NSEventModifierFlags::Control
                    | NSEventModifierFlags::Option,
        ...
        assert_eq!(
            super::native_key_smoke_event("shift-page-down"),
