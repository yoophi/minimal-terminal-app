...
pub(crate) fn legacy_mouse_report(code: u16, row: usize, col: usize, release: bool) -> Vec<u8> {
    let code = if release { LEFT_RELEASE } else { code };
...
mod tests {
    ...
    fn encodes_legacy_mouse_press() {
        assert_eq!(
            super::legacy_mouse_report(super::LEFT_BUTTON, 1, 2, false),
    ...
    fn encodes_legacy_mouse_release() {
        assert_eq!(
            super::legacy_mouse_report(super::LEFT_BUTTON, 1, 2, true),
    ...
    fn encodes_legacy_mouse_wheel() {
        assert_eq!(
            super::legacy_mouse_report(super::WHEEL_DOWN, 0, 0, false),
